@include('frontend.header')
    ...
    <div class="breadcumb-area bg-img" style="background-image: url(frontend/img/bg-img/b5.jpg);">
                ...
                <div class="col-12 col-lg-4">
                    <div class="single-blog-area clearfix mb-100">
                        ...
                        <div class="single-blog-content">
                            <div class="line"></div>
                            <a href="#" class="post-tag">Crypto</a>
                            <h4><a href="#" class="post-headline">Welcome to this Crypto blog</a></h4>
    ...
    <div class="cool-facts-area section-padding-100-0 bg-img background-overlay" style="background-image: url(frontend/img/bg-img/b4.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-12">
