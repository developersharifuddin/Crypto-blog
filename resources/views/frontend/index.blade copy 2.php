                ...
                <div class="col-12 col-lg-4 mt-0">
                    <div class="single-blog-area clearfix mb-50">
                        ...
                        <div class="single-blog-content">
                            ...
                            <h4><a href="{{ url('/') }}" class="post-headline">Welcome to this Cripto Detector blog</a></h4>
                                ...
                                <div class="c">
                                    <div class="post-head col-12 col-md-12 px-0 pt-2">
                                        ...
                                        <div class="px-2 my-auto">
                                            <div class="user" style="line-height: .4;">
                                                <h4 class="post-tag font-weight-700"><a href="{{ route('singlepost',$post->id) }}" style="font-weight: 700 !important">Admin Cripto Currency</a></h4>
                                    ...
                                    <div class="post-meta">
                                        ...
                                        <p class="w-50 d-flex" style="float:right">
                                            ...
                                            <span class="loved"><span class="lovevalue">50</span></span>k Loves</span></p>
                                        <br>
