            ...
            <div class="col-md-12 border-0">
                <div class="card shadow-none mt-3">
                    ...
                    <div class="card-body border">
                        ...
                        <table class="table table-sm table-responsive-sm table-responsive-md-none" id="example1">
                            <thead>
                                <tr>
                                    <th>SN</th>
                                    <th>Image</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{!! \Illuminate\Support\Str::limit(strip_tags($post->description), 400, '...') !!}</td>
                                    <td>{{ $post->created_at }}</td>
                                    <td class="status">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input toggleStatus" data-id="{{ $post->id }}" data-url="{{ route('post.status', $post->id) }}" type="checkbox" {{ $post->is_active ? 'checked' : '' }} style="width:35px !important;height:20px !important; border-radius:20px !important">
                                        </div>
                                    </td>
