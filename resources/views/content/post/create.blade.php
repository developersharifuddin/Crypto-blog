...
<div class="content-wrapper">
        <div class="container-fluid">
            <div class="row">
               <div class="col-12">
                   <h6 class="pt-4"><span>Post Create </span>
                    ...
                    <div class="card shadow-none border-0 mt-3" style="background: none !important">
                        <div class="card-header px-0 border-0 shadow-0 d-block d-lg-none" style="background: none !important">
                           <button type="button" class="btn btn-info-cs float-right" data-bs-toggle="modal" data-bs-target="#modal-md">
                               <i class="fa fa-plus"></i>  Post Create
                           </button>
                        </div>
                        <!-- /.card-header -->
                                    ...
                                    <form action="{{ route('post.store') }}" method="POST" enctype="multipart/form-data" id="validate_form">
                                        ...
                                        <div class="row">
                                            <div class="mb-3 col-12 col-md-6">
                                                ...
                                                data-parsley-maxlength-message="Maximum length of type name is 200">
                                            ...
                                            <div class="mb-3 col-12 col-md-6">
                                                ...
                                                <textarea  id="summernote" rows="6" name="description" class="form-control card-outline card-info @error('description') is-invalid @enderror" id="description" placeholder="description">
                                                    Place <em>Your</em> <u>Descriptions</u> <strong>here</strong>
                                                </textarea>
...
{{--
                                            <div class="mb-3 col-12 col-md-6">
                                                ...
                                                <input type="text" name="logo" class="form-control  @error('logo') is-invalid @enderror" id="logo"
                                                    placeholder="logo">
                                                    @error('logo') <div class="alert alert-danger  bg-transparent border-0 py-1 px-0">{{ $message }}</div> @enderror
                                            </div> --}}
