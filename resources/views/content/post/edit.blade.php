                                    ...
                                    <form action="{{route('post.update',$post->id) }}" method="POST"  enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-12 col-md-6">
                                                ...
                                                <input type="text" name="sub_title" class="form-control" value="{{$post->sub_title}}"  @error('sub_title') is-invalid @enderror" id="sub_title"
                                            ...
                                            <div class="mb-3 col-12 col-md-6">
                                                ...
                                                <textarea id=""rows="6" name="description" class="form-control  @error('description') is-invalid @enderror" id="description" placeholder="description">  {{$post->title}} </textarea>
