                                          ...
                                          <div class="row px-4 bg-white">
                                              <table class="table" id="addtable">
                                                  <thead class="text-start">
                                                      ...
                                                      <tr class=" ">
                                                          <th colspan="1" class="ml-3 text-start"> Size <span class="text-danger fw-bold">*</span></th>
                                              ...
                                              <table id="example" class="table border-none mt-1">
                                                  <thead class="">
                                                      <th colspan="1" class="ml-3"> Color <span class="text-danger fw-bold">*</span></th>
                                              ...
                                              <table id="example" class="table border-none mt-1">
                                                  <thead class="">
                                                      <th colspan="1" class="ml-3"> Product Image<span class="text-danger fw-bold">*</span> </th>
                                                    ...
                                                    <div class="row px-4 bg-white">
                                                        ...
                                                        <table id="example" class="table border-none mt-3">
                                                            <thead class="">
                                                                ...
                                                                <th class="text-center"> <span rel="tooltip" title="addcolorRow" class="btn btn-info btn-sm addcolorRow"><i class="fas fa-add"></i></a></span> </th>
                                                            </thead>
                                                            <tbody id="tblRowcolor">
                                                                <tr class="parent_info_child_tr">
  ...
  <script>
      function add_parent_info_row() {
          ...
          var tblRow = '<tr class="parent_info_child_tr">' +
              '<td  id="itemDetails">' +
                '<div class="form-group">'+
                    '<select name="size_name[]" id="size_name" class="form-control form-select bg-transparent" required>'+
                    '<option value="" selected>Select a size</option>'+
      ...
      $('body').on('click', '.addcolorRow', function() {
          var trcolor = '<tr class="parent_info_child_tr">'+
              '<td id="itemDetails">' +
                '<div class="form-group">'+
                    '<select name="color_name[]" id="color" class="form-control form-select bg-transparent" required>'+
                    '<option value="" selected>Select a color</option>'+
      ...
      $('body').on('click', '.addimgRow', function() {
          var tr = '<tr class="parent_info_child_tr">'+
              '<td id="itemDetails">' +
              '<div class="form-group">' +
              '<input type="file" name="product_image[]" id="product_image" class="form-control ignore" accept="image/*" required multiple />' +
              '</div>' +
