        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <button data-bs-toggle="tooltip" data-bs-placement="top" type="button" data-url="{{ route('trashed.restore', $post->id) }}" data-id="{{ $post->id }}" class="btn btn-sm bg-light shadow restore_btn text-success border-success" title="Restore"><i class="fa fa-hard-drive" aria-hidden="true"></i></button>
