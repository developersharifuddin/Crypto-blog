                ...
                <form action="{{url('updateService',$data->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="icon" class="form-control" id="icon" value="{{$data->icon}}" required="">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="sub_title" class="form-control" id="sub_title"  value="{{$data->sub_title}}" required="">
                        </div>
                    </div>
                     <!-- /.card-body -->
