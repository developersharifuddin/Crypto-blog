        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-success">
                        <div class="inner">
                            <h3>{{$TotalProgram}}<sup style="font-size: 20px"></sup></h3>

                            <p>Total Program Decleare</p>
                        </div>
                        <div class="icon">
                            <i class="ion ion-stats-bars"></i>
                        </div>
                        <a href="{{url('/program')}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div class="card border-primary mt-3" style="overflow: hidden;">
                        ...
                        <div class="card-body p-0">
                            <table class="table  table-sm table-striped px-0">
                                <thead>
                                    <tr>
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div class="card border-primary mt-3" style="overflow: hidden;">
                        ...
                        <div class="card-body p-0">
                            <table class="table  table-sm table-striped px-0 w-100">
                                <thead>
